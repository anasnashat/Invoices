...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('payment.update', ['invoices'=>$invoices,'invoices_payments'=>$payment]) }}" method="post" autocomplete="off">
                        @csrf
                        @method('Put')
                        {{-- 1 --}}
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select id="product" name="product" class="form-control" readonly>
                                    <option value="{{ $invoices->product_id}}"> {{ $invoices->product->product_name  }}</option>
                                </select>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                @if($invoices->status == 1)
                                    <input class="form-control" disabled="disabled" value="مدفوعة" readonly>
                                @elseif($invoices->status == 2)
                                    <input class="form-control" disabled="disabled" value="مدفوعة جزئيا" readonly>
                                @else
                                    <input class="form-control" disabled="disabled" value="غير مدفوعه" readonly>
                                @endif
                            </div>
                            ...
                            <div class="col">
                                <label>المتبقي</label>
{{--                                @dd($payment)--}}
                                <input class="form-control" name="difference" value="{{ $payment->difference }}" placeholder="المتبقي "
                                       type="number" readonly>

                            </div>
                            <div class="col">
                                <label>المبلغ المدفوع</label>
                                <input class="form-control" name="payment_amount" value="{{ $payment->payment_amount }}" placeholder="المبلغ المدفوع"
