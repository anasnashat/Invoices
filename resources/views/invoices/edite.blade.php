...
{{--                        @dd($invoices)--}}
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="invoice_date" value="{{ $invoices->invoice_date }}" placeholder="YYYY-MM-DD"
                                       type="text"  required>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="Amount_Commission"
                                       name="amount_commission" value="{{ $invoices->amount_commission }}" title="يرجي ادخال مبلغ العمولة "
                                       oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                       required>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="Discount" value="{{ $invoices->discount }}" name="discount"
