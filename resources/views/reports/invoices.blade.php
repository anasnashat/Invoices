...
@section('title')
    تقرير الفواتير - انس للادارة الفواتير
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{route('reports.invoices_filter')}}" method="POST" role="search" autocomplete="off">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                            <p class="mg-b-10">تحديد نوع الفواتير</p><select class="form-control select2" name="status"
                                >
