...
@section('title')
    تقرير العملاء - انس للادارة الفواتير
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{route('reports.customers_filter')}}" method="POST" role="search" autocomplete="off">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                            ...
                            <select id="product" name="product_id" class="form-control select2">
                                <option value=" " selected disabled>كل المنتجات</option>
                            </select>
                        </div>
                        ...
                        <table id="example" class="table key-buttons text-md-nowrap" style=" text-align: center">
                            ...
                            @foreach ($invoices as $invoice)
                                <tr>
                                    ...
                                    <td><a
                                            href="{{ route('invoices.show',$invoice) }}">{{ $invoice->section->name }}</a>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        @elseif($invoice->status == 2)
                                            <span class="text-danger">partial paid</span>
                                        @else
